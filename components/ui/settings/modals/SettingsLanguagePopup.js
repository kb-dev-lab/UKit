					...
					<View style={theme.popup.container}>
						...
						<View style={{ marginVertical: 8 }}>
							<TouchableOpacity
								...
								<MaterialIcons
									name={
										language === 'fr' ? 'radio-button-on' : 'radio-button-off'
									}
									size={24}
							...
							<TouchableOpacity
								...
								<MaterialIcons
									name={
										language === 'en' ? 'radio-button-on' : 'radio-button-off'
									}
									size={24}
									color={theme.popup.radioIconColor}
								/>
							...
							<TouchableOpacity
								...
								<MaterialIcons
									name={
										language === 'es' ? 'radio-button-on' : 'radio-button-off'
									}
									size={24}
									color={theme.popup.radioIconColor}
								/>
								<Text style={theme.popup.radioText}>
									{Translator.get('SPANISH')}
								</Text>
							</TouchableOpacity>
						</View>
					</View>
